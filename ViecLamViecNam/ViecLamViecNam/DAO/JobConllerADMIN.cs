...
namespace ViecLamViecNam.DAO
{
    ...
    //    public static List<DoanhNghiep_TuyenDung> GetListJob_File_SearchAD(ModelCty db, int Sec, int pageSize, string strTK)
    //    {
    ...
    //        return mode;
    //    }
    //    public static int GetPageCountJob_File_SearchAD(ModelCty db, string strTK)
    //    {
    ...
    //        return mode;
    //    }
    //    public static int GetTotal_DuyetHot_NICEAD(ModelCty db)
    //    {
    //        int mode = 0;
    ...
    //    public static List<DoanhNghiep_TuyenDung> GetList_DuyetHot_NICEAD(ModelCty db, int Sec, int pageSize)
    //    {
    ...
    //        return mode;
    //    }
    //    public static int GetTotal_Duyet_NiceAD(ModelCty db)
    //    {
    //        int mode = 0;
    //        mode = ListDuyet_NICEAD(db).Count();
    //        return mode;
    //    }
    //    public static List<DoanhNghiep_TuyenDung> GetList_Duyet_NICEAD(ModelCty db, int Sec, int pageSize)
    //    {

    //        var mode = ListDuyet_NICEAD(db);
    //        return mode;
    //    }
    //    public static List<DoanhNghiep_TuyenDung> GetListCheck_Job(ModelCty db, int Sec, int pageSize)
    //    {
    ...
    //        return mode;
    //    }
    //    public static List<DoanhNghiep_TuyenDung> CheckAll_Job(ModelCty db)
    //    {
    //        var mode = ListChoDuyet(db);
    //        return mode;
    //    }
    //    public static int GetPageCountCheck_Job(ModelCty db)
    //    {
    //        var mode = 0;
    //        mode = ListChoDuyet(db).Count();
    //        return mode;
    //    }
    //    private static List<DoanhNghiep_TuyenDung> ListDuyet_Hot(ModelCty db)
    //    {
    //        var mode = ListTD(db).Where(p => p.TinhTrangHoSo == 3 && p.NoiBat == true);
    //        return mode.ToList();
    //    }

    //    private static List<DoanhNghiep_TuyenDung> ListDuyet_NICEAD(ModelCty db)
    //    {
    //        var model = ListTD(db).Where(p => p.TinhTrangHoSo == 3);
    //        return model.ToList();
    //    }
    //    private static List<DoanhNghiep_TuyenDung> ListChoDuyet(ModelCty db)
    //    {
    //        var model = ListTD(db).Where(p => p.TinhTrangHoSo == 2 && p.NgayHetHan > DateTime.Now && p.HienThiWeb ==true);
    //        return model.ToList();
    //    }
    //    private static List<DoanhNghiep_TuyenDung> ListTD(ModelCty db)
    //    {
    ...
    //            "FROM [VLCty].[dbo].[DoanhNghiep_TuyenDung] " +
