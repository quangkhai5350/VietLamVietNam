...
namespace ViecLamViecNam.DAO
{
    public class NTV_HoSoXinViec_Dao
    {
        ...
        public static List<KhachHang_TimViecLam> LinQ_HSTV(ModelCty db)
        {
        ...
        private static List<KhachHang_TimViecLam> LinQ_HSTV_StrAPI(ModelCty db, string str)
        {
        ...
        //01/04/2020
        public static List<KhachHang_TimViecLam> GetListNTV_phuhop_NoSkip(ModelCty db, int Sec, int pageSize, int nganhKDID,string strnganh, string strtencty)
        {
        ...
        public static int GetListNTV_phuhop_NoSkip_count(ModelCty db, int nganhKDID, string strnganh,string strtencty)
        {
            var mode = model_ListNTV.Where(p => p.NganhMongMuon_ID == nganhKDID || p.TenHoSo.ToLower().Contains(strnganh.ToLower())
                            || p.TenHoSo.ToLower().Contains(strtencty.ToLower()))
                    .Count();
        ...
        public static List<KhachHang_TimViecLam> LinQ_TimViec_left(ModelCty db)
        {
        ...
        public static Object GetList_HSNTV_Cty(ModelCty db, int Id, int KH_ID)
        {
        ...
        public List<KhachHang_TimViecLam> GetmapTVLbyTieudeTD(int TD_ID)
        {
            ...
            for (int i = 0; i < modelallmap.Count(); i++)
            {
                ...
                var modelmapSub = dbc.aspnet_mapSub.Where(kh => kh.mapautoId == id)
                    .Select(kh => kh.Substr)
                    .ToList();
                if (modelmapSub != null)
                {
        ...
        public static List<KhachHang_TimViecLam> GetListNTV_XemNhieu(ModelCty db, int Skip, int take)
        {
            var mode = new List<KhachHang_TimViecLam>();
            if (Skip == 0)
            {
        ...
        public static List<KhachHang_TimViecLam> GetListNTV_moinhat(ModelCty db,int skip, int take)
        {
            var mode = new List<KhachHang_TimViecLam>();
            if (skip == 0)
            {
        ...
        public static Object GetListNTV_Skip(ModelCty db, int Sec, int pageSize)
        {
            var mode = model_ListNTV
                        .OrderByDescending(p => p.NgayCapNhat)
                        .Skip(Sec * pageSize)
        ...
        public static Object GetListNTV_NoSkip(ModelCty db, int Sec, int pageSize)
        {
            var mode = model_ListNTV
                        .OrderByDescending(p => p.NgayCapNhat)
                        .Take(pageSize * (Sec + 1))
        ...
        public static Object GetListCustomNTV_NoSkip(ModelCty db, int Sec, int pageSize, string strTK)
        {
        ...
        public static Object GetListCustomNTV_Skip(ModelCty db, int Sec, int pageSize, string strTK)
        {
            var mode = LinQ_HSTV_StrAPI(db, strTK)
                        .OrderByDescending(p => p.NgayCapNhat)
                        .Skip(Sec * pageSize)
        ...
        public static Object GetListLocationNTV_Skip(ModelCty dbc, int Sec, int pageSize, int Id)
        {
        ...
        public static Object GetListLocationNTV_NoSkip(ModelCty dbc, int Sec, int pageSize, int Id)
        {
            if (HttpContext.Current.Session["searchStrNTV"] != null)
            {
                string strTK = HttpContext.Current.Session["searchStrNTV"].ToString();
        ...
        //nhutcc
        public static List<KhachHang_TimViecLam> GetListNTV_XemNhieu(ModelCty db)
        {
            var mode = model_ListNTV
                        .OrderByDescending(p => p.LuotXem)
                        .Take(7)
        ...
        private static List<KhachHang_TimViecLam> LinQ_HSTV_byKH(ModelCty db, int KHID)
        {
