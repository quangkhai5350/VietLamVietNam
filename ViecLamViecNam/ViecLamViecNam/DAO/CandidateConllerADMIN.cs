...
namespace ViecLamViecNam.DAO
{
    public class CandidateConllerADMIN
    {
        ...
        public static List<KhachHang_TimViecLam> GetListCan_File(ModelCty db, int Sec, int pageSize)
        {
        ...
        public static int GetPageCountCan_File(ModelCty db)
        {
            int model = 0;
        ...
        public static List<KhachHang_TimViecLam> GetListCan_File_Search(ModelCty db, int Sec, int pageSize, string strTK)
        {
            var model = db.KhachHang_TimViecLam.Where(c => c.TinhTrangPheDuyetHoSo_ID == 3 && db.KhachHangs.FirstOrDefault(kh => kh.KH_ID == c.KH_ID) != null
                                        && db.KhachHangs.FirstOrDefault(kh => kh.KH_ID == c.KH_ID).HocVan_ID != null
                                        && db.KhachHangs.FirstOrDefault(kh => kh.KH_ID == c.KH_ID).TamTru_Huyen_ID != null
        ...
        public static int GetPageCountCan_File_Search(ModelCty db, string strTK)
        {
            var model = 0;
            model = db.KhachHang_TimViecLam.Where(c => c.TinhTrangPheDuyetHoSo_ID == 3 && db.KhachHangs.FirstOrDefault(kh => kh.KH_ID == c.KH_ID) != null
                                        && db.KhachHangs.FirstOrDefault(kh => kh.KH_ID == c.KH_ID).HocVan_ID != null
        ...
        public static List<KhachHang_TimViecLam> GetListCheck_CanADMIN(ModelCty db, int Sec, int pageSize)
        {
        ...
        public static int GetPageCountCheck_CanADMIN(ModelCty db)
        {
            var model = 0;
        ...
        public static List<KhachHang_TimViecLam> GetListCan_FileCheckAllADMIN(ModelCty db)
        {
            var Model = db.KhachHang_TimViecLam.Where(c => c.TinhTrangPheDuyetHoSo_ID == 2 && db.KhachHangs.FirstOrDefault(kh => kh.KH_ID == c.KH_ID) != null
                                        && db.KhachHangs.FirstOrDefault(kh => kh.KH_ID == c.KH_ID).HocVan_ID != null
                                        && db.KhachHangs.FirstOrDefault(kh => kh.KH_ID == c.KH_ID).TamTru_Huyen_ID != null
